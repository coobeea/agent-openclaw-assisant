...
2. 部署方案:
   • 主机模式: 直接使用 loopback，仅本机访问
     访问: http://127.0.0.1:18800/
   
   • Docker 模式: loopback + Nginx 代理
     OpenClaw: 127.0.0.1:3000 (无认证)
     Nginx: 0.0.0.0:18900 (代理)
     访问: http://127.0.0.1:18900/ (局域网可访问，无需 Token)
